...
from vaeProject import loss_function
...
def train_vae(epoch, model, train_loader, cond=False, losses=[], vanilla=False):
    """
    Train a VAE or CVAE!
    ...
    print('Train Epoch: {} \tLoss: {:.6f}, total:{}'.format(
        epoch, loss.data, train_loss))
    return train_loss
